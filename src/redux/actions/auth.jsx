...
export const startLogin = (accountNumber, password) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "https://backend-bank-production-9394.up.railway.app/api/v1/users/login",
        {
          accountNumber,
          password,
        }
...
export const startRegister = (name, password) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "https://backend-bank-production-9394.up.railway.app/api/v1/users/signup",
        { name, password }
      )
      .then((resp) => {
        localStorage.setItem("token", resp.data.token);
...
export const startChecking = () => {
  return (dispatch) => {
    ...
    axios
      .get(
        "https://backend-bank-production-9394.up.railway.app/api/v1/users/renew",
        getConfig()
      )
      .then((resp) => {
