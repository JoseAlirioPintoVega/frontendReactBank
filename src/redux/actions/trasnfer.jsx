...
export const startTransferTo = (amount, accountNumber, senderUserId) => {
  return (dispatch) => {
    ...
    axios
      ...
      .post(
        "https://backend-bank-production-9394.up.railway.app/api/v1/transfers",
        {
          amount,
          accountNumber,
          senderUserId,
...
export const startGetHistoryTransfer = (id) => {
  return (dispatch) => {
    ...
    axios
      .get(
        `https://backend-bank-production-9394.up.railway.app/api/v1/users/${id}/history`,
        getConfig()
      )
      .then((resp) => {
        console.log(resp);
...
export const startConsign = (data) => {
  return (dispatch, getState) => {
    ...
    axios
      .post(
        "https://backend-bank-production-9394.up.railway.app/api/v1/transfers/upload",
        {
          amount: data.amount,
          userId: auth.id,
        },
...
export const startDeleteAccount = (data) => {
  return (dispatch, getState) => {
    ...
    axios
      .patch(
        `https://backend-bank-production-9394.up.railway.app/api/v1/users/close/account/${auth.id}`,
        {
